...
describe Classifier::NGramExtractor do
  ...
  it "creates bigrams" do
    ngram.bigrams.should == { "Ho" => 1, "ow" => 1, "w " => 1, " m" => 1, "mu" => 1, "uc" => 3,
                              "ch" => 3, "h " => 1, " w" => 3, "wo" => 3, "oo" => 2, "od" => 2,
                              "d " => 2, "ou" => 1, "ul" => 1, "ld" => 1, " a" => 1, "a " => 1,
                              "dc" => 1, "hu" => 2, "ck" => 1, "k " => 1, " c" => 1}
  end
  it "creates trigrams" do
    ngram.trigrams.should == { "How" => 1, "ow " => 1, "w m" => 1, " mu" => 1, "muc" => 1, "uch" => 1,
                               "ch " => 1, "h w" => 1, " wo" => 3, "woo" => 2, "ood" => 2, "od " => 1,
                               "d w" => 1, "wou" => 1, "oul" => 1, "uld" => 1, "ld " => 1, "d a" => 1,
                               " a " => 1, "a w" => 1, "odc" => 1, "dch" => 1, "chu" => 2, "huc" => 2,
                               "uck" => 1, "ck " => 1, "k c" => 1, " ch" => 1 }
  end
  it "creates quadgrams" do
    ngram.ngrams(4).should == { "How " => 1, "ow m" => 1, "w mu" => 1, " muc" => 1,
